...
import 'package:richie_the_waiter/auth_feature/presentation/widgets/goto_login_page.dart';
import 'package:richie_the_waiter/auth_feature/presentation/widgets/password_textfield.dart';
import 'package:richie_the_waiter/auth_feature/presentation/widgets/register_button.dart';
...
class SignUpPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text(ProjectConstants.signupPageTitle,
          ...
          return Center(
            ...
            child: Column(
              ...
              children: [
                ...
                const Expanded(flex: 10, child: GoToLoginPage()),
                const Spacer(flex: 15)
              ],
            ),
          ));
